...
Entities are listed with their `routes.detail` path, pages with their slug. Nothing else to wire up — do **not** add `@astrojs/sitemap` for Flyo content, it would not see the CMS routes.
